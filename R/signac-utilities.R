...
#   if (verbose) {
#     message(
#       "Creating pseudobulk profiles for ", ncol(x = one_hot_matrix),
...
#   bulk_matrix <- sweep(
#     x = feat_cell_matrix %*% one_hot_matrix, MARGIN = 2,
...
# #' rownames(counts) <- c(
# #'   "chr1-565107-565550", "chr1-569174-569639",
